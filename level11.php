...
<section id="leveln">
<header>
Level 11 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
<table id="qwerty2">
<tr><td><img style=" margin-left:420px;"src="alvl11.jpg"></td><td><img src="blvl11.jpg"></td></tr><!--level code starts------------------------------------------------>
</table>
