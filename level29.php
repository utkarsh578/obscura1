...
<section id="leveln">
<header>
Level 29 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
</header>
<!--<div id="images">
<img style="margin-left:50px;" height=350 width=300 src="a29lvl.jpg"><img style="margin-left:0px;" height=350 width=300 src="b29lvl.jpg"><img style="margin-left:0px;" height=350 width=300 src="c29lvl.jpg">
</div>-->
<br>
<br>
<br>
...
<h1 style="font-size:40px;">"lets break all cipher</h1><br><!--level code starts------------------------------------------------>
<pre>		             <h1 style="font-size:30px; margin-left:150px">-23 june 2012"</h1></pre>
</div>
...
<!--okay another cipher solve it 

wcet hdjjmg tcm bmldus
-->
</body>
</html>
