...
<section id="leveln">
<header>
Level 14 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
<br>
<img id="qwerty2" style="margin-left:250px; "height="230" src="all.jpg"><!--level code starts------------------------------------------------>
