...
<section id="leveln">
<header>
Level 3 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
<table style="margin-left:250px;">
<tr><td><img height="200" width="200"  src="alvl3.jpg"></td><!--level code starts-->
<td><img height="200" width="200" src="blvl3.png"></td><!--level code starts-->
<td><img height="200" width="200" src="clvl3.jpg"></td><!--level code starts-->
<td><img height="200" width="200" src="elvl3.jpg"></td><!--level code starts-->
<tr >
<td><img  height="200" width="200" src="flvl3.jpg"></td><!--level code starts-->
<td><img height="200" width="200" src="glvl3.jpg"></td><!--level code starts-->
<td><img height="200" width="200" src="hlvl3.jpg"></td></tr><!--level code starts-->
</table>
