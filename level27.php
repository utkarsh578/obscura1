...
<section id="leveln">
<header>
Level 27 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
</header>
<div id="images"><!--level code starts------------------------------------------------><!--level code starts------------------------------------------------><!--level code starts------------------------------------------------>
<img style="margin-left:0px;" height=350 width=250 src="anegetive.jpg"><img style="margin-left:0px;" height=350 width=250 src="apositive.jpg"><img style="margin-left:0px;" height=350 width=250 src="bnegetive.jpg"><img style="margin-left:0px;" height=350 width=250 src="bpositive.jpg">
</div>
