...
<title>Chumpkin,Pumpkin,Humpkin.....</title>
<div class="sidebar">
...
<!--level code starts--><!--level code starts--><!--level code starts--><!--level code starts-->
<img id="eventback" src="images/ccc.jpg">
<section id="leveln">
<header>
Level 6 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
</header>
<div id="images">
<img style="margin-left:260px;margin-top:2%" src="6levelsix.jpg"><!--level code starts-->
</div>
