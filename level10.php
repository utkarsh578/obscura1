...
<!--level code starts--><!--level code starts--><!--level code starts-->
<img id="eventback" src="images/ccc.jpg">
<section id="leveln">
<header>
Level 10 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
<img id="qwerty" style="margin-left:540px" src="blur.jpg"><!--level code starts--><!--level code starts--><!--level code starts-->
...
<!--dont you wish the image was more _____-->
</html>
