...
<section id="leveln">
<header>
Level 12 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
<img id="qwerty" style="margin-left:525px;"src="jupiter.jpg"><!--level code starts------------------------------------------------>
