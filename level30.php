...
<section id="leveln">
<header>
Level 30 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
</header>
<div id="images">
<img style="margin-left:196px;" height=350 width=300 src="alvl30.jpg"><img style="margin-left:0px;" height=350 width=300 src="blvl30.jpg">
</div>
