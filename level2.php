...
<section id="leveln">
<header>
Level 2 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span>
</header>
<div id="images">
<img src="l1.jpg" style="margin-left:170px"><!--level code starts-->
</div>
