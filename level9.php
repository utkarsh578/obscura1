...
<section id="leveln">
<header>
Level 9 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
</header>
<table id="qwerty2">
<tr><td><img style="margin-left:360px;"src="alvl12.jpg"></td><td><img src="blvl12.jpg"></td></tr><!--level code starts------------------------------------------------>
</table>
