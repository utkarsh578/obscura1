...
if(!empty($_SESSION['username'])){
	   ...
	   $date = date("Y-m-d H:i:s");
		...
		else if($count['level']>=$level){$x=$count['level'];}
		else
			header("location:redirect_overflow.php");
...
<section id="leveln">
<header>
Level 1 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span>
</header>
<div id="images">
<img style="margin-left:200px;" src="lvl1.jpg">
</div>
