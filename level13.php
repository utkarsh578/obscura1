...
<section id="leveln">
<header>
Level 13 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
<img id="qwerty" style="margin-left:400px;" src="13lvlthirteen.jpg" ><!--level code starts------------------------------------------------>
