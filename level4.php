...
<section id="leveln">
<header>
Level 4 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header><!--level code starts-->
</header><!--level code starts-->
<div style="height:300px;width:500px;margin-left:480px;font-size:200px;margin-bottom:-50px;"><?php echo random();?></div><!--level code starts-->
