...
<section id="leveln">
<header>
Level 7 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
</header>
<div id="images">
<img style="margin-left:35%;" src="memoir.jpg"><!--level code starts-->
</div>
