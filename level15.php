...
<section id="leveln">
<header>
Level 15 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
</header><br>
<img id="qwerty2" style="margin-left:270px;" src="a15lvlfifteen.jpg"><!--level code starts------------------------------------------------>
...
<!--the only one that matters is the .Person Next God-->
