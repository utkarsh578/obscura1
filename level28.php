...
<section id="leveln">
<header>
Level 28 <span style="margin-left:800px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
</header>
<div id="images">
<img style="margin-left:328px;" height=350 weidth=350 src="lvl28.jpg"><!--level code starts------------------------------------------------>
</div>
