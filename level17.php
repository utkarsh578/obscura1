...
<section id="leveln">
<header>
Level 17 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header><br>
<img id="qwerty" style="margin-left:505px;" src="16lvlsixteen.jpg"><!--level code starts------------------------------------------------>
