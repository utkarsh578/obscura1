...
<!--you have won already stop now-->

<img id="eventback" src="images/ccc.jpg">
<section id="leveln">
<header>
Level 25 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
</header>
<div id="images">
<img style="margin-left:200px;" height=350 weidth=350 src="1,.jpg"><!--level code starts------------------------------------------------>
</div>
...
<!--okay so now this image isnt going to help so move on to the next-->
</body>
</html>
