...
<section id="leveln">
<header>
Level 18 <span style="margin-left:800px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
</header>
<div id="images">
<div style="margin-left:330px;font-size:30px;margin-top:150px">he made it possible hint:hotel	</div>
<br>
<br>
<br>
