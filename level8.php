...
<section id="leveln">
<header>
Level 8 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
</header>
<table style="margin-left:23%;margin-top:2px;">
<tr>
<td><img src="alvl8.jpg"></td><td><img src="blvl8.jpg"></td><td><img src="clvl8.jpg"></td><!--level code starts--><!--level code starts--><!--level code starts-->
</tr>
</table>
...
<!--these 3 Irish born were born to be big. While the eldest went to new york ,the other two went to hollywod.
but alas both of them didnt meet the same end while one went to become one of the biggest icon of hollywood ,the other died in WW1--> 
</body>
</html>
