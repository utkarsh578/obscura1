...
<section id="leveln">
<header>
Level 24 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
</header>
<div id="images">
<br>
<br>
...
<span> <input type="submit" value="submit"><i class="fa fa-hand-o-up"></i></span><!--level code starts------------------------------------------------>
</form>
</footer>
</section>
<div id="footer">
...
<!--this question has been taken hostage by level 23 find it.-->
</body>
</html>
