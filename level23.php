...
<section id="leveln">
<header>
Level 23 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
</header>
<div id="images">
<img style="margin-left:380px;" height=350 weidth=350 src="vbgyor.jpg"><!--level code starts------------------------------------------------>
</div>
