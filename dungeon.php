...
<?php  echo	
	...
	?>
	<?php
	$x=$count['level'];echo "<script>var x='$x';var links=document.querySelectorAll('.sidebar li');for(var i=0;i<=x;i++){links[i].style.display='inline';}</script>";
...
<section id="leveln">
<header>
Level 18 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
</header>
<div id="images">
<img src="door.jpg" usemap="#dor" style="margin-left:50px">
<map name="dor">
<area shape="rect" coords="120,205,200,400" href="level1811.php" alt="1">
<area shape="rect" coords="300,205,400,400" href="level1821.php" alt="2">
<area shape="rect" coords="500,205,600,400" href="level1831.php" alt="3">
<area shape="rect" coords="685,205,775,400" href="level1841.php" alt="4">
