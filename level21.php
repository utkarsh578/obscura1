...
<title>ERROR 404:coudnt find the golden bird</title>
<div class="sidebar">
...
<section id="leveln">
<header>
Level 21 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
</header>
<div id="images">
<img style="margin-left:280px;" height=350 weidth=350 src="21lvl.jpg"><!--level code starts------------------------------------------------>
</div>
