...
<title>It is fair..isnt it?</title>
<div class="sidebar">
...
<section id="leveln">
<header>
Level 16 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header><br>
<table id="qwerty2">
<tr><td><img style="margin-left:440px;" src="a16lvlsixteen.jpg"></td><td><img src="b16lvlsixteen.jpg"></td></tr><!--level code starts------------------------------------------------>
</table>
