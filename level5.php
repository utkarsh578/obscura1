...
<section id="leveln">
<header>
Level 5 <span style="margin-left:700px; font-family: 'bebas';">Welcome <?php echo $count['name'];?></span></header>
</header>
<div id="images"><!--level code starts------------------------------------------------>
<div style="position: absolute; z-index:2"><img style="margin-left:270px;margin-top:180px" height=180 width=467 src="alvl5.jpg"></div><div style="position: relative; z-index:1"> <img style="margin-left:270px;" height=350 weidth=350 src="blvl5.jpg"></div>
</div>
<br>
<span id="erroruser" class="error" style="margin-left:650px; color:red;position:absolute;"><?php echo $ansErr;?></span>
